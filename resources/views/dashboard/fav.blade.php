                    ...
                    <div class="col-md-3 col-lg-3 col-sm-3 col-xs-6 weui-pb20 bottomline">
                        <div class="yicw">
                            ...
                            <form action="{{ route('fav/remove') }}" method="POST">
                                ...
                                <div class="yichu" style="cursor: pointer;@if(!empty($_GET["r"])&&$_GET["r"]=="1") display:block; @else display:none; @endif"><input type="submit" style="background: none;" value="移除"></div>
                            </form>
