                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="ponewicon">
                                            ...
                                            <li><form action="/dashboard/report" class="m-nav__link" method="POST">
                                                ...
                                                <input type="hidden" name="to" value="{{$to->id}}}">
                                                <button type="submit" style="background: none; border: none; padding: 0">
                                                <li><img src="/images/new_03.png" class="popicon"><span>檢舉</span></li>
                                                </button>
                                            </form></li>
                                            ...
                                            @if($isBlocked)
                                                <li><form action="/dashboard/unblock" class="m-nav__link" method="POST">
                                                    ...
                                                    <input type="hidden" name="to" value="{{$to->id}}}">
                                                    <button type="submit" style="background: none; border: none; padding: 0">
                                                    <li><img src="/images/new_05.png" class="popicon"><span>解封</span></li>
                                                    </button>
                                                </form></li>
                                            @else
                                                <li><form action="/dashboard/block" class="m-nav__link" method="POST">
                                                    ...
                                                    <input type="hidden" name="to" value="{{$to->id}}}">
                                                    <button type="submit" style="background: none; border: none; padding: 0">
                                                    <li><img src="/images/new_05.png" class="popicon"><span>封鎖</span></li>
                                                    </button>
                                                </form></li>
                                             @endif
                                        ...
                                        @if(!empty($messages))
                                            @foreach ($messages as $message)
                                                ...
                                                <li @if($message['from_id'] == $user->id) class="text_2n" @endif>
                                                    @if($date_temp != substr($message['created_at'],0,10)) <p style="text-align: center;font-size: #999;font-size: 14px;"> {{substr($message['created_at'],0,10)}} </p> @endif
                                                    <div class="imgInfo">
                                                    @if($message['from_id'] == $user->id)
                                                    <img src="@if(file_exists( public_path().$user->meta_()->pic )){{$user->meta_()->pic}} @else/img/male-avatar.png @endif" alt="" height="40" width="40" />
                                                    @else
                                                    <img src="@if(file_exists( public_path().$msgUser->meta_()->pic )){{$msgUser->meta_()->pic}} @else/img/male-avatar.png @endif" alt="" height="40" width="40" />
                                                    @endif
                                                    </div>
