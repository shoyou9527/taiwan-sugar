...
return [
    ...
    'payment_test' => [
        ...
        'ReturnURL' => "https://ming.test-tw.icu/dashboard/upgradepayEC",  //背景傳送付款結果的網址
        'postChatpayReturnURL' => "https://ming.test-tw.icu/dashboard/postChatpayEC",  //背景傳送車馬費付款結果的網址
        'PeriodReturnURL' => "https://ming.test-tw.icu/dashboard/upgradepayEC",  //背景傳送定期定額付款交易結果的網址
        'ClientBackURL' => "http://ming.test-tw.icu/dashboard", //返回商店的網址
        // 'OrderResultURL' => "http://ming.test-tw.icu/dashboard/upgradepay",  //付款結果的網址，若不設則會使用綠界的付款結果
    ],
];
